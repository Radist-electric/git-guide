...
let gitPull = [
  {
    command: 'git pull',
    input: [],
    description: 'Притянуть (залить) к себе историю и изменения с удалённого репозитория и произвести слияние. Так как не указаны параметры, то слияние происходит с репозиторием и веткой, выбранными по умолчанию.'
  },
  {
